...
#define EI_CLASSIFIER_PROJECT_ID                 840750
#define EI_CLASSIFIER_PROJECT_OWNER              "RoseMaker"
#define EI_CLASSIFIER_PROJECT_NAME               "RoseMaker-project-Compressor"
...
#define EI_CLASSIFIER_FUSION_AXES_STRING         "Lever_pos + Ship_speed + GTT_torque + GT_rpm + GG_rpm + Starboard_Prop_T + Port_Prop_T + HP_T_exit_temp + GT_Comp_in_temp + GT_Comp_out_temp + HP_T_exit_press + GT_Comp_in_press + GT_Comp_out_press + GT_exhaust_press + TIC_control + Fuel_flow"
...
#define EI_CLASSIFIER_THRESHOLD                  0.01
...
#define EI_CLASSIFIER_TFLITE_LARGEST_ARENA_SIZE     2732
